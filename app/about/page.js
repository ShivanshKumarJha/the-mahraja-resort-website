    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-accent-400 font-medium">
          Welcome to The Maharaja Resort
        </h1>
      ...
      <div className="relative aspect-square col-span-2">
        <Image
          ...
          alt="Family that manages The Maharaja Resort"
        />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Maharaja Resort has been a cherished family-run
          ...
          <p>
            Over the years, we&apos;ve maintained the essence of The Maharaja
            ...
            us at The Maharaja Resort soon, where tradition meets tranquility,
